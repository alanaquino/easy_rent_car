...
switch ($accion) {
    ...
    case 'agregar':
        ...
        $sentenciaSQL = $conexion->query("INSERT INTO `cars` (vehicle_type, brand, model, level, year, type, foto_principal,
        ...
        move_uploaded_file($tmpImagen, "uploads/" . $nombre_archivo);
...
/*
    ...
    case 'seleccionar':
        ...
        case 'borrar':
            ...
            $sentenciaSQL = $conexion->prepare("DELETE FROM cars WHERE id = $txtID");
            $sentenciaSQL->execute();
