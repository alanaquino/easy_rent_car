			...
			<div class="details_section sec_ptb_100 pb-0 clearfix">
				<div class="container">
					...
					<div class="mb_30" data-aos="fade-up" data-aos-delay="500">
						...
						<a class="custom_btn bg_default_red text-uppercase mb-0" href="login.php">Rentar este vehículo <img src="assets/images/icons/icon_01.png" alt="icon_not_found"></a>
